...
class TieBreakTest {
    ...
    @Test
    fun `player started the tie-break on just started tie-break`() {
    ...
    @Test
    fun `player started the tie-break on first point`() {
    ...
    @Test
    fun `player started the tie-break after eight points is currently serving (1 + 2 + 2 + 2 + 1)`() {
    ...
    @Test
    fun `player started the tie-break after eleven points is currently serving (1 + 2 + 2 + 2 + 2 + 2)`() {
    ...
    @Test
    fun `player started the tie-break after six points is NOT currently serving (1 + 2 + 2 + 1)`() {
    ...
    @Test
    fun `player started the tie-break after nine points is NOT currently serving (1 + 2 + 2 + 2 + 2)`() {
